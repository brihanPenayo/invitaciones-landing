...
export const Header = () => {
    return (
        <header class="bg-[rgb(254,243,199,0.8)] fixed top-0 w-screen z-50">
            <nav class="mx-auto flex max-w-7xl items-center justify-between p-6 lg:px-8" aria-label="Global">
                ...
                <div class="hidden lg:flex lg:flex-1 lg:justify-end gap-[4rem]">
                    ...
                    <a href="#contact" class="-mx-3 block rounded-lg px-3 py-2 text-base font-semibold font-body leading-7 hover:bg-amber-200">Contacto</a>
                </div>
            </nav>
        </header>
    )
